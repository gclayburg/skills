...
@test "push_completion_stage_lines_match_tty_and_non_tty_output" {
    cd "${TEST_REPO}"

    echo "Push stage consistency test" >> README.md
    git add README.md
    git commit --quiet -m "Push stage consistency test"
...
WRAPPER_END
    ...
    echo "Push stage consistency test second run" >> README.md
    git add README.md
    git commit --quiet -m "Push stage consistency test second run"
